...
import com.baxter.config.processor.repo.RepositoryImpl;
 ...
 */
public final class FileBasedProcessorFactory implements ProcessorFactory
{
  ...
  private static final Logger LOGGER = LoggerFactory
      .getLogger(FileBasedProcessorFactory.class);
   ...
   */
  private FileBasedProcessorFactory(final File repositoryRoot) throws ProcessorException
  {
    LOGGER.trace("Creating factory with repository at {}",
        repositoryRoot.getAbsolutePath());
    this.repository = RepositoryImpl.getInstance(repositoryRoot);
    loadProcessors();
  }
  ...
  public static ProcessorFactory getInstance(final File repository)
      throws ProcessorException
  {
    return new FileBasedProcessorFactory(repository);
  }
      ...
      final Processor processorDescriptor) throws ProcessorException
  {
    ...
    try
    {
      ...
      final Constructor<? extends AbstractProcessor> processorConstructor = processorClass
          .getConstructor(Descriptor.class, FileBasedProcessorFactory.class);
